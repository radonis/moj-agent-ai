...
export default function ReportPage() {
  ...
  return <main className="page page-scroll app-page"><AppNav /><section className="report-shell">
    ...
    <div className="report-tools" aria-label="Źródła i narzędzia agenta"><span>Źródła i narzędzia agenta</span><div><span>🌐 Google Search <small>gdy włączony</small></span><span>📚 Wikipedia</span><span>📄 Strony WWW</span><span>🧮 Kalkulator</span></div></div>
