...
export function ThemeToggle() {
  ...
  useEffect(() => { const savedTheme = window.localStorage.getItem("radonis-theme"); const nextTheme: Theme = savedTheme === "dark" ? "dark" : "light"; document.documentElement.dataset.theme = nextTheme; setTheme(nextTheme); }, []);
